...
psql -U postgres -c "CREATE TABLE GPS (GROUPNAME TEXT NOT NULL, USERNAME TEXT REFERENCES CREDS(USERNAME))"
psql -U postgres -c "CREATE TABLE CHATROOMS(USERNAME TEXT REFERENCES CREDS(USERNAME), BUDDY TEXT REFERENCES CREDS(USERNAME))"
